...
buildscr = 2
downlurl := "https://raw.githubusercontent.com/Vlad112005/RockOust/master/updt.exe"
downllen := "https://raw.githubusercontent.com/Vlad112005/RockOust/master/rasta.ini"
...
WM_HELP(){
IniRead, vupd, %a_temp%/rasta.ini, UPD, v
IniRead, desupd, %a_temp%/rasta.ini, UPD, des
desupd := Utf8ToAnsi1(desupd)
IniRead, updupd, %a_temp%/rasta.ini, UPD, upd
...
URLDownloadToFile, %downllen%, %a_temp%/rasta.ini
IniRead, buildupd, %a_temp%/rasta.ini, UPD, build
if buildupd =
{
